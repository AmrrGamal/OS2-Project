...
public class multiThreading  implements Runnable {
	...
	//dimensions of pieces
        ...
        (int[][] board, int[] usablePieces,ArrayList<int[][]> solutions ,HashMap<Integer,ArrayList<int[][]>> pieces) {
					...
					for(int boardX = 0; boardX < boardXdim; boardX++) {
						...
						if(returnValue) {	
							...
							//recursion
								...
								solve(newBoard, newPieces, solutions,pieces);
							}
						}
					}
				}
	...
	public static boolean doesSolutionExist(int[][] sol,ArrayList<int[][]> solutions) {
        ...
        public void run(){
                        ...
                        //start solving
                        solve(board, usablePieces, solutionsThread,piecesThread);
